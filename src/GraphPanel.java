...
public class GraphPanel extends JPanel {
    ...
    private Color lineColor = new Color(230, 0, 32, 180);
    ...
    private void paintGraph(Graphics2D g2, List<Point> graphPoints) {
    ...
    private void paintPoints(Graphics2D g2, List<Point> graphPoints) {
    ...
    private void paintHatchMarksForXAxis(Graphics2D g2, int padding, int labelPadding) {
    ...
    private void paintHatchMarksForYAxis(Graphics2D g2, int padding, int labelPadding) {
    ...
    private void paintBackground(Graphics2D g2, int padding, int labelPadding) {
    ...
    private void paintAxis(Graphics2D g2, int padding, int labelPadding) {
    ...
    private List<Point> getListOfPoints() {
        int padding = 25;
        int labelPadding = 25;
